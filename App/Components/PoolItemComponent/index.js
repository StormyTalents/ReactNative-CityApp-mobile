...
class PoolItemComponent extends React.PureComponent {
  render() {
    let { onPress, date, time, image, liked, name, location, city, online, distance, status, rate, likePress, number } = this.props;
    return (
