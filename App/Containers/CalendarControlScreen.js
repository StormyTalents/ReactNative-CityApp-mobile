...
import styles from './Styles/CalendarControlScreenStyles'
import dummyData from '../Themes/DummyData'

export default class CalendarControlScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <ScrollView style={styles.mainContainer}>
        ...
        <View style={styles.section}>
          ...
          <FAQLabel label={Languages.Calendar_control} icon={Images.calendar_control} />
