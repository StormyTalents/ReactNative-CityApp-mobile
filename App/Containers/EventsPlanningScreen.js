...
import styles from './Styles/EventsPlanningScreenStyles'
import dummyData from '../Themes/DummyData'

export default class EventsPlanningScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <ScrollView style={styles.mainContainer}>
        ...
        <View style={styles.section}>
          ...
          <FAQLabel label={Languages.Events_planning} icon={Images.event_planning} />
