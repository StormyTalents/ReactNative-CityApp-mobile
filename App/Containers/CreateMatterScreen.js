...
import styles from './Styles/CreateMatterScreenStyles'
import dummyData from '../Themes/DummyData'

export default class CreateMatterScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <ScrollView style={styles.mainContainer}>
        ...
        <View style={styles.section}>
          ...
          <FAQLabel label={Languages.Create_matters} icon={Images.matter_create} />
