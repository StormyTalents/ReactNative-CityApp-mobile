...
import styles from './Styles/ReportFollowupScreenStyles'
import dummyData from '../Themes/DummyData'

export default class ReportFollowupScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <ScrollView style={styles.mainContainer}>
        ...
        <View style={styles.section}>
          ...
          <FAQLabel label={Languages.Report_follow_up} icon={Images.report} />
